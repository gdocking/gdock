...
class TestPDB(unittest.TestCase):
    ...
    def test_load(self):
        ...
        expected_coords = [(2.945, -15.164, 18.823),
                           (6.035, -13.796, 20.667),
                           (8.279, -16.791, 19.929),
                           (10.599, -16.062, 16.976),
                           (11.893, -18.739, 14.665)]
        expected_raw_pdb = [('ATOM      1  CA  CYS A   1       2.945 -15.164'
                             '  18.823  1.00 13.76      A   '
                             '19  ') + os.linesep,
...
class TestRestraint(unittest.TestCase):
    def setUp(self):
        raw_pdb = {'A': [('ATOM      1  CA  CYS A   1       2.945 -15.164'
                   ...
                   'B': [('ATOM      1  CA  CYS B   1       2.945 -15.164'
                          '  18.823  1.00 13.76      A   19  ' + os.linesep),
